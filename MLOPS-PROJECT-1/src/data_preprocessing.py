...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            logger.info('Dropping the unrequired columns')
            ...
            logger.error(f'Error duing preprocess step: {e}')
    ...
    def select_features(self, df):
        try:
            ...
            logger.error(f'Error duing feature selection step: {e}')
    ...
    def save_data(self, df, file_path):
        try:
            ...
            logger.error(f'Error duing saving data step: {e}')
    ...
    def process(self):
        try:
            ...
            test_df = test_df[train_df.columns]         # to select top columns from train_df 
            ...
            logger.error(f'Error duing preprocessing pipeline: {e}')
